// ============================================================
// ORDERS.JS — Página de pedidos (pedidos.html)
// ============================================================
...
function createOrderCard(pedido, index) {
    ...
    // Calcular taxa de entrega (total − subtotal dos itens)
    ...
    if (pedido.status === 'pendente') {
        // Qualquer usuário pode cancelar seu próprio pedido pendente
        acoes += `<button class="btn-cancelar" onclick="cancelarPedido(${pedido.id})">
            ✕ Cancelar
        </button>`;
    }

    // Cliente pode confirmar entrega para qualquer pedido não-finalizado
