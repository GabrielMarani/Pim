...
// carrega e exibe a página do carrinho
...
// atualiza os totais do resumo do pedido
...
// configura eventos dos botões da página
...
// envia o pedido para a API e redireciona para a página de pedidos

async function finalizarPedido() {
    // exige login para finalizar
    if (!auth.estaLogado()) {
