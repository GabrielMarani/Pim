...
// debounce para otimizar buscas com digitação
...
// retorna o nome da categoria pelo slug
function getCategoryName(slug) {
    const cat = categorias.find(c => c.id === slug);
    return cat ? cat.nome : slug;
}

// retorna classe e texto do badge de status do pedido
...
// navbar — compartilhada entre todas as páginas
...
// modo escuro — compartilhado entre todas as páginas
